...
<p></p><p>Thanks &amp; Regards,
                ...
                $mail = NotificationTemplate::create([
                    ...
                    'default_content' => '<p><img src="{app_logo}" style="height: 75px"></p>
<p>
</p><p><span style="background-color: var(--form-control-bg) ; color: var(--default-font-color) ;">Hola {receiver_name}</span><br></p><p>Recibimos tu solicitud para restablecer la contrasena en {app_name}. Presiona el boton de abajo para continuar.</p><br>
