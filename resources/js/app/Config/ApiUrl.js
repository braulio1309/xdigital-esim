...
export const BENEFICIARIOS_VISUAL_COMMISSIONS = (id) => `beneficiarios/${id}/visual-commissions`;
...
export const TRANSACTIONS_SEND_RECHARGE_EMAIL = (id) => `transactions/${id}/send-recharge-email`;
