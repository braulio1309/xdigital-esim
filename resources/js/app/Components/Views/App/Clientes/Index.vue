<template>
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 breadcrumb-side-button">
                <div class="float-md-right mb-3 mb-sm-3 mb-md-0">
                    <button type="button"
                            class="btn btn-secondary btn-with-shadow mr-2"
        ...
        <import-modal v-if="isImportModalActive"
                      :table-id="tableId"
                      :is-beneficiario="userIsBeneficiario"
...
<script>
    ...
    export default {
        ...
        created() {
            // Detect if the logged-in user is a beneficiario
            this.axiosGet('login-user')
                .then(response => {
                    this.userIsBeneficiario = response.data.user_type === 'beneficiario';
                })
                .catch(() => {
                    this.userIsBeneficiario = false;
                });
        },
        methods: {
            openImportModal() {
