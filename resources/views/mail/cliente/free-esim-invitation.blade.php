                ...
                <tr>
                    <td style="padding:28px 32px;">
                        ...
                        <p style="margin:0 0 8px;">
                            <a href="{{ $activationUrl }}" style="display:inline-block; background:#2d9cdb; color:#ffffff; text-decoration:none; padding:14px 20px; border-radius:10px; font-weight:700;">
